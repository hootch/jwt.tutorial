...
public class AuthController {
    ...
    public ResponseEntity<TokenDto> authorize(@Valid @RequestBody LoginDto loginDto) throws InterruptedException {
        ...
        String jwt = tokenProvider.createToken(authentication, "access");
        ...
        httpHeaders.add(JwtFilter.AUTHORIZATION_REFRESH,"Refresh " + refreshJwt);
